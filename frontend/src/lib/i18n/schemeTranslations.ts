...
> = {
  ...
  pmay: {
    ...
    benefit: "पक्का घर बनाने या खरीदने के लिए वित्तीय सहायता / ब्याज सब्सिडी",
    documents: ["आधार कार्ड", "आय प्रमाण पत्र", "भूमि दस्तावेज़ (यदि स्वामित्व हो)", "बैंक पासबुक"],
    official_note: "शहरी (PMAY-U) और ग्रामीण (PMAY-G) संस्करणों की आय सीमाएं और आवेदन प्रक्रिया अलग-अलग हैं।",
  },
  pmmvy: {
