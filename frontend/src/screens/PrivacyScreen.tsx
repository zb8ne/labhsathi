  ...
  return (
    <div className="flex min-h-screen flex-col bg-dark-bg text-dark-text">
      ...
      <main className="flex-1 px-6 pb-16 pt-4 text-center sm:px-14">
        ...
        <p className="mx-auto mb-12 max-w-[56ch] text-[15px] text-dark-secondary sm:mb-14">{t.privacy.subhead}</p>

        <div className="mx-auto flex max-w-5xl flex-col items-center gap-8 sm:flex-row sm:items-stretch sm:justify-center sm:gap-0">
          <PipelineStep number={1} title={t.privacy.step1Title} iconColor="#fbbf24" description={t.privacy.step1Body}>
            <rect x="3" y="6" width="18" height="14" rx="2" />
            <path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" />
            <circle cx="12" cy="13" r="3.2" />
          </PipelineStep>
          <PipelineArrow />
          <PipelineStep number={2} title={t.privacy.step2Title} iconColor="#fb923c" description={t.privacy.step2Body}>
            <circle cx="12" cy="12" r="3" />
            <path d="M12 2v3M12 19v3M4.2 4.2l2.1 2.1M17.7 17.7l2.1 2.1M2 12h3M19 12h3M4.2 19.8l2.1-2.1M17.7 6.3l2.1-2.1" />
          </PipelineStep>
          <PipelineArrow />
          <PipelineStep number={3} title={t.privacy.step3Title} iconColor="#f87171" description={t.privacy.step3Body}>
            <path d="M4 7h16M9 7V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2m-9 0 1 12a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2l1-12" />
          </PipelineStep>
          <PipelineArrow />
          <PipelineStep number={4} title={t.privacy.step4Title} iconColor="#5eead4" iconBg="#1a2e29" iconBorder="#2d5147" description={t.privacy.step4Body}>
